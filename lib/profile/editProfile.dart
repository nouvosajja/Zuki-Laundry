...
class _EditProfileState extends State<EditProfile> {
  ...
  void initState() {
    super.initState();
    // Panggil fungsi untuk mengambil data profil dari API saat halaman diinisialisasi
    _fetchUserProfile();
  }
  ...
  Future<void> _fetchUserProfile() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final userProfile = UpdateModel.fromJson(json.decode(response.body));
        setState(() {
          _userProfile = userProfile;
          // Set nilai awal di dalam TextFormField sesuai dengan data dari API
          _nameController.text = userProfile.name;
          _numberController.text = userProfile.number;
