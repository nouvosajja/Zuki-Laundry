                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(children: [
                        ...
                        Spacer(),
                        const Text('Cuci Setrika / 3 hari : Rp. 12.000/kg', style: TextStyle(color: Colors.white, fontSize: 12), ),
                      ]),
                    ),
                    ...
                    Container(
                      ...
                      child: Row(children: [
                        ...
                        Spacer(),
                        const Text('Cuci Setrika / 5 hari : Rp. 9.000/kg', style: TextStyle(color: Colors.white, fontSize: 12)),
                      ]),
                    ),
                    ...
                    Container(
                      ...
                      child: Row(children: [
                        ...
                        Spacer(),
                        const Text('Cuci Setrika / 7 hari : Rp. 6.000/kg', style: TextStyle(color: Colors.white, fontSize: 12)),
                      ]),
                    ),
                    ...
                    Container(
                      ...
                      child: Row(children: [
                        ...
                        Spacer(),
                        const Text('Setrika / 3 hari : Rp. 6.000/kg', style: TextStyle(color: Colors.white, fontSize: 12),),
                      ]),
                    ),
                  ],
                ),
