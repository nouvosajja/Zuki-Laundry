                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Order(data: widget.data, price: priceList[0],)),
                          );
                        },
                        child: Row(
                          children: [
                            ...
                            Center(
                              child: Text(
                                '${priceList[0].waktu} ${priceList[0].nama} \n : Rp ${priceList[0].harga.toString()}/kg',
                                style: TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.bold,
                                ),
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Order(data: widget.data, price: priceList[1])),
                          );
                        },
                        child: Row(
                          children: [
                            ...
                            Center(
                              child: Text(
                               '${priceList[1].waktu} ${priceList[1].nama} \n : Rp ${priceList[1].harga.toString()}/kg',
                                style: TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.bold,
                                ),
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Order(data: widget.data, price: priceList[2])),
                          );
                        },
                        child: Row(
                          children: [
                            ...
                            Center(
                              child: Text(
                                '${priceList[2].waktu} ${priceList[2].nama}  \n : Rp ${priceList[2].harga.toString()}/kg',
                                // 'Setrika / 3 hari \n: Rp 6.000/kg',
                                style: TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.bold,
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => Order(data: widget.data, price: priceList[3])),
                          );
                        },
                        child: Row(
                          children: [
                            ...
                            Center(
                              child: Text(
                                '${priceList[3].waktu} ${priceList[3].nama} \n : Rp ${priceList[3].harga.toString()}/kg',
                                style: TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.bold,
                                ),
