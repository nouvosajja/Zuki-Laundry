...
class HomePage_guest extends StatefulWidget {
  ...
  @override
  State<HomePage_guest> createState() => _HomePageState();
}

class _HomePageState extends State<HomePage_guest> {
  int myIndex = 0;
  List<Widget> widgetList = const [HomePage_guest(), Riwayat(), Proses()];
